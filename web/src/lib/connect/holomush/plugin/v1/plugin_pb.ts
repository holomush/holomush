 ...
 *
 * @generated from message holomush.plugin.v1.PluginHostServiceCharacterRef
 */
export type PluginHostServiceCharacterRef = Message<"holomush.plugin.v1.PluginHostServiceCharacterRef"> & {
  /**
   * id is the character ULID.
   *
   * @generated from field: string id = 1;
...
/**
 * Describes the message holomush.plugin.v1.PluginHostServiceCharacterRef.
 * Use `create(PluginHostServiceCharacterRefSchema)` to create a new message.
 */
export const PluginHostServiceCharacterRefSchema: GenMessage<PluginHostServiceCharacterRef> = /*@__PURE__*/
...
export type PluginHostServiceQueryLocationCharactersResponse = Message<"holomush.plugin.v1.PluginHostServiceQueryLocationCharactersResponse"> & {
   ...
   *
   * @generated from field: repeated holomush.plugin.v1.PluginHostServiceCharacterRef characters = 1;
   */
  characters: PluginHostServiceCharacterRef[];
};
...
export const PluginHostServiceQueryLocationCharactersResponseSchema: GenMessage<PluginHostServiceQueryLocationCharactersResponse> = /*@__PURE__*/
  messageDesc(file_holomush_plugin_v1_plugin, 61);

/**
 * PluginHostServiceQueryObjectRequest names the object to snapshot; it carries
 * no subject.
 *
 * @generated from message holomush.plugin.v1.PluginHostServiceQueryObjectRequest
 */
export type PluginHostServiceQueryObjectRequest = Message<"holomush.plugin.v1.PluginHostServiceQueryObjectRequest"> & {
  /**
...
/**
 * Describes the message holomush.plugin.v1.PluginHostServiceQueryObjectRequest.
 * Use `create(PluginHostServiceQueryObjectRequestSchema)` to create a new message.
 */
export const PluginHostServiceQueryObjectRequestSchema: GenMessage<PluginHostServiceQueryObjectRequest> = /*@__PURE__*/
  messageDesc(file_holomush_plugin_v1_plugin, 62);
 ...
 *
 * @generated from message holomush.plugin.v1.PluginHostServiceQueryObjectResponse
 */
export type PluginHostServiceQueryObjectResponse = Message<"holomush.plugin.v1.PluginHostServiceQueryObjectResponse"> & {
  /**
...
/**
 * Describes the message holomush.plugin.v1.PluginHostServiceQueryObjectResponse.
 * Use `create(PluginHostServiceQueryObjectResponseSchema)` to create a new message.
 */
export const PluginHostServiceQueryObjectResponseSchema: GenMessage<PluginHostServiceQueryObjectResponse> = /*@__PURE__*/
  messageDesc(file_holomush_plugin_v1_plugin, 63);
...
export const PluginHostService: GenService<{
  ...
  queryObject: {
    methodKind: "unary";
    input: typeof PluginHostServiceQueryObjectRequestSchema;
    output: typeof PluginHostServiceQueryObjectResponseSchema;
  },
  /**
