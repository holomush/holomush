...
[Audit-Chain Primer](/extending/explanation/audit-chain/) for chain structure details
and escalate to a developer with access to the `events_audit` table.

## See also

- [Crypto Runbook](/operating/how-to/crypto/crypto-runbook/) — operator procedures for rekey operations
