...
[Authentication](/operating/explanation/authentication/) for storage and rate limiting details --
...
| Review rate-limit logs | The per-username lockout (see [Authentication](/operating/explanation/authentication/)) still applies on telnet           |
