...
[Emitting Audit Events from Plugins](audit-events.md).
...
- [Crypto Runbook](../operating/crypto-runbook.md) — operator procedure for the rekey chain
- [Crypto Monitoring](../operating/crypto-monitoring.md) — alert rules for chain-integrity failures
- [Sub-epic E design spec §3.6–§3.8](../../../docs/superpowers/specs/2026-05-10-event-payload-crypto-phase5-sub-epic-e-design.md) — full primitive design and R6 amendment
- [Master spec §4.6](../../../docs/superpowers/specs/2026-04-25-event-payload-crypto-design.md) — audit event shapes
