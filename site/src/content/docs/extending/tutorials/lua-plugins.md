...
For the full plugin system overview, see [Plugin Guide](/extending/tutorials/plugin-guide/).
...
`"internal error (ref: XXXX...)"`. See [Plugin Guide](/extending/tutorials/plugin-guide/#error-handling)
