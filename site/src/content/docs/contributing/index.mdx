...
4. **Find an issue** — look for `good-first-issue` labels, or browse [open issues](https://github.com/holomush/holomush/issues) for unblocked tasks
...
```mermaid
flowchart TB
    A["Spec (docs/specs/)"] --> B["Epic (tracked in GitHub Issues)"]
...
1. Pick a task from [open issues](https://github.com/holomush/holomush/issues)
