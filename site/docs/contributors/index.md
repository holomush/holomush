...
HoloMUSH is an open-source project licensed under Apache-2.0. We welcome contributions
of all kinds, from code to documentation to bug reports.
...
- [Development Environment](development.md) - Set up your local environment
- [Building from Source](building.md) - Compile HoloMUSH
- [Running Tests](testing.md) - Execute the test suite

### Contribution Process

- [Pull Request Guide](pull-requests.md) - How to submit changes
- [Code Review](code-review.md) - What to expect in reviews
- [Coding Standards](standards.md) - Style and conventions

### Project Information

- [Roadmap](roadmap.md) - Planned features and milestones
- [Architecture Decisions](decisions.md) - ADRs explaining key choices
...
All participants must follow our [Code of Conduct](code-of-conduct.md).
