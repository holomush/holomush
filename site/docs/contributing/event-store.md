...
the former LISTEN/NOTIFY architecture, see [Event Delivery (superseded)](./event-delivery.md).

**Design spec**: [docs/superpowers/specs/2026-04-18-jetstream-event-log-design.md](../../../../docs/superpowers/specs/2026-04-18-jetstream-event-log-design.md)
...
- Superseded architecture: [Event Delivery](./event-delivery.md)
