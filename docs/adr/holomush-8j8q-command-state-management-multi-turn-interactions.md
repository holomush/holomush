...
# Command State Management for Multi-Turn Interactions

**Date:** 2026-02-02
**Status:** Proposed (Deferred to post-v1)
**Decision:** holomush-8j8q
**Originally:** ADR 0005
...
_See Decision section above. The original ADR did not have a separate Rationale section._
