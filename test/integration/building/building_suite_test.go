...
func TestBuilding(t *testing.T) {
	...
	RunSpecs(t, "Building & Objects Integration Suite")
}
...
func setupBuildingTestEnv() (*testEnv, error) {
...
func cleanupAll(ctx context.Context, pool *pgxpool.Pool) {
