...
// TestIsEligibleVoterRole pins INV-P6-1: only owner and member are eligible
...
func TestIsEligibleVoterRole(t *testing.T) {
	...
	assert.False(t, IsEligibleVoterRole("invited"), "INV-P6-1: invited members are NOT on the voter roster")
