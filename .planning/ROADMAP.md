...
- [ ] 02-01-PLAN.md — TRACER: confusable-name rejection end-to-end (generator, skeleton, §6.1.1 pipeline, migration 000054, one create path)
- [ ] 02-02-PLAN.md — Mixed-script restriction, empty-normal-form, and the IDENT-08 username regression pin
- [ ] 02-03-PLAN.md — ABAC vocabulary: viewer/profile/admin_section prefixes, ViewerTierProvider with its roles seam
...
- [ ] 02-13-PLAN.md — Row-identity resolution: player-scoped roles, PropertyProvider player-keyed peers, provider registration
