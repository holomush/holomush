...
const file_holomush_plugin_v1_plugin_proto_rawDesc = "" +
	...
	"emitEvents2h\n" +
	"\x06Plugin\x12^\n" +
	"\vHandleEvent\x12&.holomush.plugin.v1.HandleEventRequest\x1a'.holomush.plugin.v1.HandleEventResponseB\xd8\x01\n" +
	"\x16com.holomush.plugin.v1B\vPluginProtoP\x01ZGgithub.com/holomush/holomush/internal/proto/holomush/plugin/v1;pluginv1\xa2\x02\x03HPX\xaa\x02\x12Holomush.Plugin.V1\xca\x02\x12Holomush\\Plugin\\V1\xe2\x02\x1eHolomush\\Plugin\\V1\\GPBMetadata\xea\x02\x14Holomush::Plugin::V1b\x06proto3"
