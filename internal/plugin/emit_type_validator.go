...
// registered set before INV-PLUGIN-32 set-equality comparison. Per INV-PLUGIN-34.
...
// per INV-PLUGIN-34). Per INV-PLUGIN-32, the two sets MUST be equal in both directions.
...
// set before INV-PLUGIN-32 comparison. Per INV-PLUGIN-34 — substrate filters; the
