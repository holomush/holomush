...
// TestDEKIntegration is the Ginkgo entry point for the
// internal/eventbus/crypto/dek integration suite.
func TestDEKIntegration(t *testing.T) {
	suiteT = t
	RegisterFailHandler(Fail)
	RunSpecs(t, "DEK Integration Suite")
}
