...
BEGIN
  ...
  IF EXISTS (SELECT 1 FROM information_schema.columns
    ...
    EXECUTE 'ALTER TABLE bootstrap_metadata ALTER COLUMN initialized_at TYPE BIGINT USING (EXTRACT(EPOCH FROM initialized_at) * 1e9)::BIGINT';
  ...
  IF EXISTS (SELECT 1 FROM information_schema.columns
    ...
    EXECUTE 'ALTER TABLE crypto_rekey_checkpoints ALTER COLUMN started_at TYPE BIGINT USING (EXTRACT(EPOCH FROM started_at) * 1e9)::BIGINT';
  ...
  IF EXISTS (SELECT 1 FROM information_schema.columns
    ...
    EXECUTE 'ALTER TABLE crypto_rekey_checkpoints ALTER COLUMN last_heartbeat_at TYPE BIGINT USING (EXTRACT(EPOCH FROM last_heartbeat_at) * 1e9)::BIGINT';
  ...
  IF EXISTS (SELECT 1 FROM information_schema.columns
    ...
    EXECUTE 'ALTER TABLE crypto_rekey_checkpoints ALTER COLUMN completed_at TYPE BIGINT USING (EXTRACT(EPOCH FROM completed_at) * 1e9)::BIGINT';
  END IF;
  ...
  IF EXISTS (SELECT 1 FROM information_schema.columns
    ...
    EXECUTE 'ALTER TABLE crypto_rekey_checkpoints ALTER COLUMN aborted_at TYPE BIGINT USING (EXTRACT(EPOCH FROM aborted_at) * 1e9)::BIGINT';
  END IF;
  ...
  IF EXISTS (SELECT 1 FROM information_schema.columns
    ...
    EXECUTE 'ALTER TABLE holomush_system_info ALTER COLUMN created_at TYPE BIGINT USING (EXTRACT(EPOCH FROM created_at) * 1e9)::BIGINT';
  ...
  IF EXISTS (SELECT 1 FROM information_schema.columns
    ...
    EXECUTE 'ALTER TABLE holomush_system_info ALTER COLUMN updated_at TYPE BIGINT USING (EXTRACT(EPOCH FROM updated_at) * 1e9)::BIGINT';
  ...
  IF EXISTS (SELECT 1 FROM information_schema.columns
    ...
    EXECUTE 'ALTER TABLE setting_bootstrap_state ALTER COLUMN updated_at TYPE BIGINT USING (EXTRACT(EPOCH FROM updated_at) * 1e9)::BIGINT';
