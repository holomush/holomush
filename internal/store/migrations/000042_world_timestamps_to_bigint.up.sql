...
BEGIN
  ...
  IF EXISTS (SELECT 1 FROM information_schema.columns
    ...
    EXECUTE 'ALTER TABLE characters ALTER COLUMN created_at TYPE BIGINT USING (EXTRACT(EPOCH FROM created_at) * 1e9)::BIGINT';
  ...
  IF EXISTS (SELECT 1 FROM information_schema.columns
    ...
    EXECUTE 'ALTER TABLE locations ALTER COLUMN created_at TYPE BIGINT USING (EXTRACT(EPOCH FROM created_at) * 1e9)::BIGINT';
  ...
  IF EXISTS (SELECT 1 FROM information_schema.columns
    ...
    EXECUTE 'ALTER TABLE locations ALTER COLUMN archived_at TYPE BIGINT USING (EXTRACT(EPOCH FROM archived_at) * 1e9)::BIGINT';
  END IF;
  ...
  IF EXISTS (SELECT 1 FROM information_schema.columns
    ...
    EXECUTE 'ALTER TABLE exits ALTER COLUMN created_at TYPE BIGINT USING (EXTRACT(EPOCH FROM created_at) * 1e9)::BIGINT';
  ...
  IF EXISTS (SELECT 1 FROM information_schema.columns
    ...
    EXECUTE 'ALTER TABLE objects ALTER COLUMN created_at TYPE BIGINT USING (EXTRACT(EPOCH FROM created_at) * 1e9)::BIGINT';
  ...
  IF EXISTS (SELECT 1 FROM information_schema.columns
    ...
    EXECUTE 'ALTER TABLE entity_properties ALTER COLUMN created_at TYPE BIGINT USING (EXTRACT(EPOCH FROM created_at) * 1e9)::BIGINT';
  ...
  IF EXISTS (SELECT 1 FROM information_schema.columns
    ...
    EXECUTE 'ALTER TABLE entity_properties ALTER COLUMN updated_at TYPE BIGINT USING (EXTRACT(EPOCH FROM updated_at) * 1e9)::BIGINT';
  ...
  IF EXISTS (SELECT 1 FROM information_schema.columns
    ...
    EXECUTE 'ALTER TABLE scene_participants ALTER COLUMN joined_at TYPE BIGINT USING (EXTRACT(EPOCH FROM joined_at) * 1e9)::BIGINT';
  ...
  IF EXISTS (SELECT 1 FROM information_schema.columns
    ...
    EXECUTE 'ALTER TABLE player_character_bindings ALTER COLUMN created_at TYPE BIGINT USING (EXTRACT(EPOCH FROM created_at) * 1e9)::BIGINT';
  ...
  IF EXISTS (SELECT 1 FROM information_schema.columns
    ...
    EXECUTE 'ALTER TABLE player_character_bindings ALTER COLUMN ended_at TYPE BIGINT USING (EXTRACT(EPOCH FROM ended_at) * 1e9)::BIGINT';
  END IF;
END $$;
