...
func (descriptionDefinition) Set(ctx context.Context, querier WorldQuerier, mutator WorldMutator, subjectID world.Caller, entityType string, entityID ulid.ULID, value string) error {
